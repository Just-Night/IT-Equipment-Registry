...
test:
	docker compose -f $(f) exec app pytest
...
seed:
	docker compose -f $(f) exec app python manage.py seed_demo_data

seed-force:
	docker compose -f $(f) exec app python manage.py seed_demo_data --force
